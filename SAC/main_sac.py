...
if __name__ == '__main__':
    ...
    plot_file_folder_name = 'plots'
    if not os.path.isdir(plot_file_folder_name):
        os.mkdir(plot_file_folder_name)
    
    figure_file = os.path.join(plot_file_folder_name, filename)
    if os.path.isdir(figure_file):
